    ...
    if text_area is not None:
        if st.button("Check"):
            ...
            with col1:
                ...
                result_1 = openai_detector.detect(input)
                ...
                result_2 = openai_finetune_detector.detect(input, None, None, "20240523_v1_epoch4.pth")
            ...
            with col2:
                ######################## run gptzero
                st.info("GPTZero")
                result_4 = gptzero_detector.detect(input)
                ...
                ######################## run DetectGPT
                st.info("DetectGPT")
                result_5 = detectgpt_detector.detect(input)
            ...
            with col3:
                ...
                result_3 = radar_detector.detect(input)
                ...
                result_6 = radar_finetune_detector.detect(input)
